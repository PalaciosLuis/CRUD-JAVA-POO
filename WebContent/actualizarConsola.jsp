...
<%
	Consola consola= (Consola)request.getAttribute("data");
%>
<div class="container w-50 my-auto">
	<h3>Actualizar Consola</h3>
	<form class="row g-3 needs-validation" novalidate action="ServletConsola"  method="post">
		<div class="form-group">
			...
			value=<%=consola.getNombre() %> required>
			    <div class="invalid-feedback">
    			Debe ingresar el nombre de la consola
    			</div>
		</div>
		<a href="ServletConsola?tipo=Actualizar&id=<%=consola.getIdConsola() %>" class="btn btn-primary btn-lg">Actualizar</a>
	</form>
</div>
